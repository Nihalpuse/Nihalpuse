...
<img src="./assets/banner.svg" alt="Nihal Puse — Frontend Developer" width="100%" />

### _Frontend developer crafting fast, polished web interfaces with React, Next.js &amp; TypeScript._
...
I build clean, responsive web interfaces — turning designs into fast, accessible products. Most of my work lives in the **React / Next.js / TypeScript** world, backed by **Python &amp; Flask** when a project needs the full stack.
...
- Python / Flask services and data flows to back the frontend
